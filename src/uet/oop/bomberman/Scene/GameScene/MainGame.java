...
public class MainGame extends GeneralScene {

//    public static int totalPlayers = AllSettings.userSettings.totalPlayers; // this variable is intended to write from outside classes
//    public static int totalHumanPlayers = AllSettings.userSettings.totalHumanPlayers;   // this variable is intended to write from outside classes

//    public static Color thisPlayerColor = Color.White;  // this variable is intended to write from outside classes
...
//    private static final BufferedImage unscaledScreenImage = new BufferedImage(AllSettings.unscaledWidth, AllSettings.unscaledHeight, BufferedImage.TYPE_INT_ARGB);
    private static final Image unscaledScreenImage = null;
//    private static final Graphics2D unscaledScreenGraphics = unscaledScreenImage.createGraphics();
    private static final GraphicsContext unscaledScreenGraphics = null;
...
//    private static final BufferedImage mainLocationImage = new BufferedImage(AllSettings.unscaledWidth, AllSettings.unscaledHeight, BufferedImage.TYPE_INT_ARGB);
    private static final Image mainLocationImage = null;
//    private static final BufferedImage HUD_image = new BufferedImage(GfxFromFile.HUD_Width, GfxFromFile.HUD_Height, BufferedImage.TYPE_INT_ARGB);
    private static final Image HUD_image = null;


    public static List<GraphicsObject> graphicsObjectList;
//    public static java.util.List<Player> thisPC_controlledPlayerList;
//    public static java.util.List<InputController> inputControllersList;
//    public static java.util.List<AI_Player> ai_Players;
...
//    public static Transition_Animation transitionAnimation;
    ...
    /* use for sound */
    public static final LoopingSound gameMusic = new LoopingSound(ResourceLoader.loadSound(FilePath.SoundFilePath.InGame.GameMusic), AllSettings.userSettings.backgroundMusicVolume);
    private static final Media readyGoSound = ResourceLoader.loadSound(FilePath.SoundFilePath.InGame.ReadyGoSound);
    public static final Media resultFoundSound = ResourceLoader.loadSound(FilePath.SoundFilePath.InGame.ResultFoundSound);
    public static boolean resultFoundSoundPlayed;


    public MainGame(Parent parent) {
        super(parent);
    }

    public MainGame(Parent parent, double v, double v1) {
        super(parent, v, v1);
    }

    public MainGame(Parent parent, Paint paint) {
        super(parent, paint);
    }

    public MainGame(Parent parent, double v, double v1, Paint paint) {
        super(parent, v, v1, paint);
    }

    public MainGame(Parent parent, double v, double v1, boolean b) {
        super(parent, v, v1, b);
    }

    public MainGame(Parent parent, double v, double v1, boolean b, SceneAntialiasing sceneAntialiasing) {
        super(parent, v, v1, b, sceneAntialiasing);
    }
    /*
    There are 3 situations of a draw game:
        1. When all players are dying in the exact scene
        2. When all players are dying in the almost exact scene
        3. Game is timeout
    */
