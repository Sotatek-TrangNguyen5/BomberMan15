package uet.oop.bomberman.AppInfo;

public class FilePath {

    public static class GraphicsFilePath {
        public static final String GraphicsFolder = "G:\\IdeaProjects\\BomberMan\\res\\Gfx\\";
        public static final String SpriteSheet = GraphicsFolder + "Gfx.png";
        public static final String Font = GraphicsFolder + "Font.png";
    }
